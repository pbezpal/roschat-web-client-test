...
import static data.CommentsData.CLIENT_CHATS_FIRST_MESSAGE;
...
public class TestGroupChatUser7002 extends GroupChatPage{

    @Story(value = "Ищем групповую беседу после создания на другом клиенте")
    @Description(value = "1. Авторизуемся под пользователем 7002\n" +
    ...
    @Test
    @Order(2)
    void test_Exist_Reply_Message_Group_Chat(){
